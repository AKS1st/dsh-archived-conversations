	...
	factory: (require) => {
		...
		*/
		function ArchivedSection(props) {
			...
			return React.createElement("div", { className: "dsa-section" }, React.createElement("div", { className: "dsa-header" }, selectedId !== null ? React.createElement("button", {
				type: "button",
				className: "dsa-back",
				onClick: backToList
			}, t("back")) : null, React.createElement("span", { className: "dsa-title" }, selectedId !== null && selected !== void 0 ? selected.title : t("title")), selectedId === null ? React.createElement("span", { className: "dsa-count" }, String(count)) : null), React.createElement("div", { className: "dsa-body" }, selectedId === null ? rows.length === 0 ? React.createElement("div", { className: "dsa-empty" }, t("empty")) : React.createElement("ul", { className: "dsa-list" }, rows.map((row) => React.createElement("li", { key: row.id }, React.createElement("button", {
				type: "button",
				className: "dsa-row",
				...
				key: String(index),
				className: "dsa-msg"
			}, React.createElement("span", { className: "dsa-msgRole" }, msg.role === "user" ? t("role.user") : t("role.assistant")), React.createElement("span", { className: "dsa-msgText" }, String(msg.text)))))));
		}
